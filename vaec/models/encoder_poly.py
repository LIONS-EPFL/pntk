...
def encoder(img):
	...
	# img_scaled.shape : TensorShape([Dimension(32), Dimension(128), Dimension(128), Dimension(3)])
	# encoder_conv_out.shape: TensorShape([Dimension(32), Dimension(8), Dimension(8), Dimension(32)])
	...
	encoder_FC_out, encoder_FC_w, encoder_FC_biases = mlp(encoder_conv_out_flat, encoder_FC_size,
	scope='encoder_FC', reuse=tf.AUTO_REUSE)
