...
class Evaler(object):
    ...
    def __init__(self,config):
        ...
        # Get normalization training stats
        norm_stats_fname = self.train_dir + str(self.config.checkpoint) + '_stats.hy'
        norm_stats_fid = h5py.File(norm_stats_fname, 'r')
        norm_stats = norm_stats_fid['norm_stats']
        self.config.norm_stats = norm_stats
        ...
        self.model_name = self.config.model_name + '_train_stats_trained_on_' + train_set_name + '_run' + self.config.run
